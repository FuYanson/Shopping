  ...
  <div id="header">
	<!-- {{data}} -->	
  	<div class="nav-global">
			<div class="container">
				<h1 class="nav-logo">
					<a href="javascript:;" @click="Jump"></a>
				</h1>
				<ul class="nav-aside">
					<li class="nav-user">
					...
					<!--active-->
					<li class="nav-cart"
						@mouseover="$store.commit('MyCart_show')"
						@mouseout="$store.commit('MyCart_hide')"
					>
						<a href="javascript:;">购物车</a>
						<!--根据class改变颜色-->
						<span class="cart-empty-num cart-num">
							<i>{{$store.getters.My_Total}}</i>
						</span>

						<!-- 购物车组件 -->
						<my-cart v-show="$store.state.showCart"></my-cart>
...
import data from "@/assets/datas/newGoodsData.js";
